 ...
 *
 * @author Paccha
 * @param sala entidad que posee todos los atributos que se describen en la base de datos 
 * @param salactrl entidad con la que se pueden manejar las lines de codgio sql para la base de datos 
 * @param msj entidad utlizada para mostrar mensajes en consola  
 * 
 */
